...
public class SplineComponentEditor : Editor
{
    ...
    static void DrawGizmoLoRes(SplineComponent spline, GizmoType gizmoType)
    {
    ...
    static void DrawGizmoHiRes(SplineComponent spline, GizmoType gizmoType)
    {
        Gizmos.color = Color.white;
    ...
    {
        EditorGUILayout.HelpBox("Hold Shift and click to append and insert curve points. Backspace to delete points",
            MessageType.Info);
    ...
    private void OnSceneGUI()
    {
        ...
        for (int i = 0; i < spline.points.Count; i++)
        {
            ...
            // Draw control widgets for selected control point
            if (hotIndex == i)
            {
                var newWp = Handles.PositionHandle(wp,
